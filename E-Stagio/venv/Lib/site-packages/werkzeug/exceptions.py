...
class Forbidden(HTTPException):
    ...
    code = 403
    description = (
        " Você não tem permissão para accesar a página requisitada."
        " Você pode ter fornecido credenciais inválidas ou o seu tipo de usuário não tem permissão para acessar esta página."
    )
