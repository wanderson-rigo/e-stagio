...
class BancaAvaliacaoForm(FlaskForm):
    ...
    banca_nota_apresentacao_oral_supervisor = FloatField('Nota Apresentação Oral Supervisor', validators=[DataRequired(), NumberRange(min=0, max=10)])
    banca_nota_pratica_profissional_supervisor = FloatField('Nota Prática Profissional Supervisor', validators=[DataRequired(), NumberRange(min=0, max=10)])
    banca_nota_relatorio_supervisor = FloatField('Nota Relatório Supervisor', validators=[DataRequired(), NumberRange(min=0, max=10)])
